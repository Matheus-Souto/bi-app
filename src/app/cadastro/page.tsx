    ...
    try {
      ...
      if (error) {
        ...
        if (error.message.includes('already registered')) {
          ...
          setMessage({
            type: 'error',
            text: 'Email inválido. Verifique o formato.',
          });
      ...
      if (data?.user?.identities?.length === 0) {
        setMessage({
          type: 'error',
          text: 'Usuário com este email já existe. Tente fazer login.',
        });
        return;
      }
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        setMessage({
          type: 'error',
          text: `Erro no cadastro com Google: ${error.message}`,
        });
      }
    } catch (error: any) {
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Comece sua jornada transformando dados em insights poderosos
          </p>
        </div>
